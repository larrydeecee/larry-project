...
print('\n\nHello, I am Olanrewaju Ismail Olaogun. Please let us explore the bikeshare data.')
def get_city():
    '''
    ...
    while True:
            if city == 'CHICAGO' or city == 'C':
                ...
                print("\nThat\'s fine! let\'s explore New York City data together.\n\n")
                return 'new york city'
            elif city == 'WASHINGTON' or city == 'W':
                print("\nThat\'s fine! let\'s explore Washington data together.\n\n")
                return 'washington'
            else:
                return get_city()
    return city
